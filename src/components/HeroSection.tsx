...
// // Utility to mimic cn for className concatenation
// const cn = (...classes: Array<string | undefined>) => classes.filter(Boolean).join(' ');

// // Load Pacifico font via Google Fonts
// const loadPacificoFont = () => {
...
// const Hero = ({
//   badge = 'Powered buildX ',
//   title1 = 'CS & Econ',
//   title2 = 'Oberlin College',
// }) => {
//   // Load Pacifico font on component mount
//   useEffect(() => {
//     loadPacificoFont();
//   }, []);
...
//               Build for the people/community not for yourself: buildX mission
//             </p>
//           </motion.div>
//         </div>
//       </div>
