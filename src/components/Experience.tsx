          ...
          <div className="space-y-6">
              <div className="bg-white rounded-lg shadow-sm p-6">
                  <div className="flex justify-between items-start mb-4">
                      <div>
                          <h3 className="text-3xl font-semibold">Student Software Developer</h3>
                          <p className="text-red-600 text-xl">Oberlin College & Conservatory</p>
                      </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                  <div className="flex justify-between items-start mb-4">
                      <div>
                          <h3 className="text-3xl font-semibold">IT & Web Developer</h3>
                          <p className="text-red-600 text-xl">Tujenge Africa Foundation</p>
                      </div>
